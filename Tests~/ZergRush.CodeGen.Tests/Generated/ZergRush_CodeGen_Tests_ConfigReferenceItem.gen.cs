...
namespace ZergRush.CodeGen.Tests {
    ...
    public partial class ConfigReferenceItem : IBinaryDeserializable, IBinarySerializable, IHashable, IUniquelyIdentifiable, IJsonSerializable
    {
